...
##  2 A-Bomb     FALSE   TRUE             FALSE            FALSE           
##  3 Abe Sapien TRUE    TRUE             FALSE            FALSE           
##  4 Abominati~ FALSE   TRUE             FALSE            FALSE           
##  5 Abraxas    FALSE   FALSE            FALSE            TRUE            
##  6 Absorbing~ FALSE   FALSE            FALSE            FALSE           
##  7 Adam Monr~ FALSE   TRUE             FALSE            FALSE           
##  8 Adam Stra~ FALSE   FALSE            FALSE            FALSE           
##  9 Agent Zero FALSE   FALSE            FALSE            FALSE           
## 10 Air-Walker FALSE   FALSE            FALSE            FALSE           
## # ... with 409 more rows, and 163 more variables: cold_resistance <lgl>,
