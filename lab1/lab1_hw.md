...
R is a programming language while R studio uses the R language as well as provides four quadrants for users to work and use code to create programs or visuals. GitHub allows users to share code online and interact or collaborate together.
